        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CityId = table.Column<int>(type: "int", nullable: true),
                    Severity = table.Column<double>(type: "float", nullable: true),
                    Code = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SevereWeatherEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SevereWeatherEvents_Cities_CityId",
                        column: x => x.CityId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Precipitation = table.Column<double>(type: "float", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MeteoData_Stations_StationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Meteorologists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Meteorologists_Stations_StationId",
                        column: x => x.StationId,
                        principalTable: "Stations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeteoData_StationId",
                table: "MeteoData",
                column: "StationId");

            migrationBuilder.CreateIndex(
                name: "IX_Meteorologists_StationId",
                table: "Meteorologists",
                column: "StationId");

            migrationBuilder.CreateIndex(
                name: "IX_SevereWeatherEvents_CityId",
                table: "SevereWeatherEvents",
                column: "CityId");
